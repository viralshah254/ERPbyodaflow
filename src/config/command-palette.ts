...
export const COMMAND_NAV_ITEMS: CommandItemNav[] = [
  ...
  { id: "nav-billing", label: "Billing", group: "nav", href: "/settings/billing", keywords: ["billing", "subscription", "invoices", "franchise", "seats"], icon: "CreditCard" },
  ...
  { id: "nav-notifications", label: "Notifications", group: "nav", href: "/settings/notifications", keywords: ["notifications", "email", "sms"], icon: "Bell" },
  {
    id: "nav-integrations-whatsapp",
    label: "WhatsApp orders (integrations)",
    group: "nav",
    href: "/settings/integrations/whatsapp",
    keywords: ["whatsapp", "meta", "integration", "orders", "webhook"],
    icon: "MessageCircle",
  },
