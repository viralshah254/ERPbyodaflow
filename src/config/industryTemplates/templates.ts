...
export const INDUSTRY_TEMPLATES_REGISTRY: Record<string, IndustryTemplateDefinition> = {
  ...
  /** Cool Catch Distributors Ltd — multi-source procurement, VAS/subcontracting, cold chain, franchise network, commission & VMI. */
  "cool-catch": {
    id: "cool-catch",
    name: "Cool Catch (Franchise & VAS)",
    description: "Distributor with farm-gate procurement, subcontracting/VAS, cold hub, franchise network, commission engine, and VMI replenishment. Kenya/Uganda multi-currency.",
    orgType: "DISTRIBUTOR",
    icon: "Fish",
    enabledModules: [
      "dashboard",
