...
export const NAV_SECTIONS_CONFIG: NavSectionConfig[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "ar-statements", label: "Customer statements", href: "/ar/statements", icon: "FileText", moduleKey: "finance", requiresPermissions: ["finance.ar.read"] },
      ...
      { key: "ap-statements", label: "Supplier statements", href: "/ap/statements", icon: "FileText", moduleKey: "finance", requiresPermissions: ["finance.ap.read"] },
      ...
      { key: "finance-kra-signing", label: "KRA signing monitor", href: "/finance/kra-signing", icon: "ShieldCheck", moduleKey: "finance", requiresPermissions: ["finance.read"] },
  ...
  },
  {
    ...
    items: [
      ...
      { key: "treasury-ar-statements", label: "Customer statements", href: "/ar/statements", icon: "FileText", moduleKey: "finance", requiresPermissions: ["finance.ar.read"] },
      { key: "treasury-ap-statements", label: "Supplier statements", href: "/ap/statements", icon: "FileText", moduleKey: "finance", requiresPermissions: ["finance.ap.read"] },
