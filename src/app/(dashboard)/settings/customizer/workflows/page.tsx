  ...
  return (
    <PageShell className={LIST_PAGE_SHELL_CLASS}>
      ...
      <div className={LIST_PAGE_BODY_CLASS}>
        <DataTableToolbar className="shrink-0" searchPlaceholder="Search workflows..." searchValue={search} onSearchChange={setSearch} />
        <div className={LIST_TABLE_SURFACE_CLASS}>
          <div className="shrink-0 border-b px-4 py-3">
            <h3 className="text-sm font-semibold">Custom Workflows</h3>
          </div>
          {loading ? (
